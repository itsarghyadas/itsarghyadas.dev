...
export default function Navbar() {
  return (
    <nav className="navbar sticky top-0 z-50 border border-dashed border-neutral-700/30 backdrop-blur-lg">
      <div className="mx-auto flex w-full max-w-2xl items-center justify-between border border-b-0 border-t-0 border-dashed border-neutral-700/30 p-3.5 py-2.5">
        <h1
